...
class Octaves extends StatefulWidget {
  static const route = '/octaves';

  @override
  State<Octaves> createState() => _OctavesState();
}

class _OctavesState extends State<Octaves> {
  @override
  ...
  Future<FirebasePostContent?> readPost() async {
    ...
    final docUser = FirebaseFirestore.instance.collection('/content').doc('octaves');
