...
class BassKey extends StatefulWidget {
  static const route = '/bass_key';

  @override
  State<BassKey> createState() => _BassKeyState();
}

class _BassKeyState extends State<BassKey> {
  @override
  ...
  Future<FirebasePostContent?> readPost() async {
    ...
    final docUser = FirebaseFirestore.instance.collection('/content').doc('bass_key');
